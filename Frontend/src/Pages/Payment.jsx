...
function Payment() {
  ...
  return (
    <div style={{ position: "relative" }}>
      <Link
        to="/"
        className="ml-2 mt-2 text-left text-black"
        style={{ position: "absolute", top: 0, left: 0 }}
      >
        <h1
          className="px-4 py-2 bg-[#d25f5f] text-white rounded cursor-pointer hover:bg-[#d25f5f] inline-block"
      ...
      >
        <div style={{ flex: "1", display: "flex" }}>
          ...
          >
            ...
            >
              <h1 className="text-black text-bold text-center mb-4 text-2xl">
                Send monetary via this form
              </h1>
              <Donate state={state} />
            </div>
          </div>
