...
//           <p className="mt-10">
//             Our vision is to unite generosity worldwide by connecting
//             individuals with NGOs in need. We believe every act of kindness, no
//             matter how small, creates meaningful change. Through our platform,
//             we aspire to empower people to make a difference, fostering a more
...
const Vision = () => {
  return (
    <div className="w-full bg-white py-16 px-4 min-h-screen" id="vision">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 h-full">
        <img
          className="w-[800px] md:w-[620px] h-auto mx-auto my-0 md:ml-0 md:mr-auto"
          src={vision}
          alt="/"
        />
        <div className="flex flex-col justify-center ml-16">
          <p className="text-[#d25f5f] text-3xl font-bold">Our Vision</p>
          <p className="mt-10">
            Our vision is to unite generosity worldwide by connecting
            individuals with NGOs in need. We believe every act of kindness, no
            matter how small, creates meaningful change. Through our platform,
